...
declare class FeatureData {
    ...
    getFreeOrder(): number;
    getGeoJson(includeShapeProperties?: boolean): {
        properties: {
            [x: string]: unknown;
            ...
            [x: string]: unknown;
            shape: "ellipse";
            _gm_shape_center?: LngLat | undefined;
            _gm_shape_xSemiAxis?: number | undefined;
            _gm_shape_ySemiAxis?: number | undefined;
            _gm_shape_angle?: number | undefined;
            _gmid?: FeatureId;
        };
        type: "Feature";
    ...
    getShapeProperty(name: keyof FeatureShapeProperties): number | LngLat | null | undefined;
    getShapeProperties(): FeatureShapeProperties;
...
declare const shapeNames: readonly ["marker", "ellipse", "circle", "circle_marker", "text_marker", "line", "rectangle", "polygon"];
declare const extraDrawModes: readonly ["freehand", "custom_shape"];
declare const drawModes: readonly ["marker", "ellipse", "circle", "circle_marker", "text_marker", "line", "rectangle", "polygon", "freehand", "custom_shape"];
...
type EllipseGeoJsonInternalProperties = {
...
type EllipseGeoJsonProperties = EllipseProperties & Partial<EllipseGeoJsonInternalProperties> & {
    [FEATURE_ID_PROPERTY]?: FeatureId;
};
...
type ImportEllipseGeoJsonProperties = EllipseProperties & EllipseGeoJsonInternalProperties;
...
declare abstract class BaseDrag extends BaseEdit {
    ...
    moveEllipse(featureData: FeatureData, oldLngLat: LngLat, newLngLat: LngLat): GeoJsonShapeFeature | null;
